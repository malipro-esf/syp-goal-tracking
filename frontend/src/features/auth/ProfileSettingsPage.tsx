...
const languageNames: Record<SupportedLanguage, string> = { en: 'English', fa: 'فارسی', tr: 'Türkçe', ar: 'العربية', de: 'Deutsch', ja: '日本語', 'zh-CN': '简体中文', es: 'Español', fr: 'Français', 'pt-BR': 'Português (Brasil)', hi: 'हिन्दी' }
