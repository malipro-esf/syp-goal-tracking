...
export type User = { id: string; email: string; display_name: string; bio: string | null; timezone: string; preferred_language: 'en' | 'fa' | 'tr' | 'ar' | 'de' | 'ja' | 'zh-CN' | 'es' | 'fr' | 'pt-BR'; roles: string[] }
