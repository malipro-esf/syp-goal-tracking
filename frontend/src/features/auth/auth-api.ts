...
export type User = { id: string; email: string; display_name: string; timezone: string; roles: string[] }
export type AuthResponse = { access_token: string; token_type: 'bearer'; user: User }
type Credentials = { email: string; password: string }

export const registerUser = (input: Credentials & { display_name: string; timezone: string; account_type: 'participant' | 'coach' }) =>
