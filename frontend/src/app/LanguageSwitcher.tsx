...
const languageLabelKeys: Record<SupportedLanguage, string> = {
  en: 'english', fa: 'persian', tr: 'turkish', ar: 'arabic', da: 'danish', de: 'german', el: 'greek', ja: 'japanese', 'zh-CN': 'chineseSimplified', es: 'spanish', sv: 'swedish', fr: 'french', 'pt-BR': 'portugueseBrazilian', hi: 'hindi', ko: 'korean', fi: 'finnish',
}
