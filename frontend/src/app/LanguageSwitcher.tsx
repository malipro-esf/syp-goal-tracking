...
const languageLabelKeys: Record<SupportedLanguage, string> = {
  en: 'english', fa: 'persian', tr: 'turkish', ar: 'arabic', de: 'german', ja: 'japanese', 'zh-CN': 'chineseSimplified', es: 'spanish', fr: 'french', 'pt-BR': 'portugueseBrazilian', hi: 'hindi', ko: 'korean',
}
